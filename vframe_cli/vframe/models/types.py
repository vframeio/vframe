...
InterpolationVar = click_utils.ParamVar(Interpolation)
...
DrawActionVar = click_utils.ParamVar(DrawAction)
ModelZooClickVar = click_utils.ParamVar(ModelZoo)
FrameImageVar = click_utils.ParamVar(FrameImage)
ImageFileExtVar = click_utils.ParamVar(ImageFileExt)
