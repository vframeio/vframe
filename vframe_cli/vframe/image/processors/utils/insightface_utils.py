############################################################################# 
#
# Deep Insight: Insight Face Detector
# MIT License
# Copyright (c) Jia Guo and Jiankang Deng
# https://github.com/deepinsight/insightface/
#
# https://github.com/deepinsight/insightface/blob/master/python-package/insightface/model_zoo/face_detection.py
#
#############################################################################
...
class FaceDetector:
    ...
    def __init__(self, param_file, rac, dnn_cfg):
        self.param_file = param_file
        self.rac = rac
        #self.default_image_size = (480, 640)
        self.default_image_size = dnn_cfg.size[::-1]
    ...
    def detect(self, img, threshold=0.5, scale=1.0):
        ...
        for _idx,s in enumerate(self._feat_stride_fpn):
            ...
            A = self._num_anchors['stride%s'%s]  # mask
            scores = scores[:, A:, :, :]
            ...
            #mask_scores = type_scores[:, A*2:, :, :] #x, A, x, x, mask
            ...
            #proposals = clip_boxes(proposals, im_info[:2])  # mask
        ...
        proposals = proposals[order, :]
        scores = scores[order]
        #mask_scores = mask_scores[order]  # mask
        if self.use_landmarks:
